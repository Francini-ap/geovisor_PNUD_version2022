...
ods_unidos<-
  st_read(
    "https://francini-ap.github.io/capas_visor_tfg_2022/ods_unidos.geojson",
    quiet = TRUE
  )
...
renderDT({
  ...
  registros %>%
    st_drop_geometry() %>%
   datatable(rownames= FALSE, filter= "top", class= "hover cell-border stripe", colnames = c( "Nombre proyecto", "Marcador género","Nombre donante","Presupuesto dólares ($)","Acción en los ODS"), options = list (language = list (url = "//cdn.datatables.net/plug-ins/1.10.11/i18n/Spanish.json"),pageLength = 8, dom = "Bfrtip"))
})
```
